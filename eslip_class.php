...
/**
* SuperClase de la que heredan OAuth y OpenID
*
...
class Eslip {
    ...
    */
    ...
    public function StoreUserDataInSession($user_data, $type)
    {
        ...
        // Se rompe con twitter porque me parece que la variable de session de 127.0.0.1 es diferente a la de localhost
    ...
    */
    ...
    protected function request_curl($options = array())
    {
        ...
        //OUTPUT
        curl_setopt($curl, CURLOPT_HEADER, $config['curl_header']);
        curl_setopt($curl, CURLOPT_RETURNTRANSFER, $config['curl_returntransfer']);
