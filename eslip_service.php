...
include("eslip_helper.php");

$xmlAapi = new xmlApi("config.xml");
	...
	case "wizard":
		...
		switch($action){
				...
				<div id="dialog-wizard-end" title="<?php echo WizardEndTitle; ?>" style="display:none;">
					...
					<div class="contenedorCentral borderBox">
						...
						<div style="background: #ffffff; overflow:auto;width:auto;border:solid gray;border-width:.1em .1em .1em .8em;padding:.2em .6em; line-height: 16px;">
							...
							<span style="margin-left: 40px; color: #007700">&lt;link</span> <span style="color: #0000CC">rel=</span><span style="background-color: #fff0f0">&quot;stylesheet&quot;</span> <span style="color: #0000CC">type=</span><span style="background-color: #fff0f0">&quot;text/css&quot;</span> <span style="color: #0000CC">href=</span><span style="background-color: #fff0f0">&quot;<?php echo $pluginUrl."css/zocial.css"; ?>&quot;</span> <span style="color: #007700">/&gt;</span><br/>
							<span style="margin-left: 40px; color: #007700">&lt;script </span><span style="color: #0000CC">type=</span><span style="background-color: #fff0f0">&quot;text/javascript&quot;</span> <span style="color: #0000CC">src=</span><span style="background-color: #fff0f0">&quot;<?php echo $pluginUrl."js/eslip_plugin.js"; ?>&quot;</span><span style="color: #007700">&gt;&lt;/script&gt;</span><br/>
							<span style="margin-left: 20px; color: #007700">&lt;/head&gt;</span><br/>
			...
			case "save":
				...
				$xmlAapi->setElementValue("runWizard", "0", "configuration");
				...
				//update admin user
				$xmlAapi->setElementValue("adminUser", $_POST["adminUser"], "configuration");
				$xmlAapi->setElementValue("adminPass", getEncrypted($_POST["adminPass"]), "configuration");
		...
		switch($action){
			...
			case "getWidgetHTML":
				...
				foreach ($result as $ip) {
					echo "<a href='javascript:;' class='zocial ".(string)$ip->attributes()."' style='font-size: 14px;' onclick='clickLogin(\"".(string)$ip->attributes()."\")' >".$ip->label."</a>";
				}
